...
<dsp:page>
	...
	<dsp:form action="EmployeeRegistrationForm.jsp" method="post">
		...
		<b>Employee Id : - </b>
		<dsp:input type="text" bean="EmployeeProfileFormHandler.id" paramvalue="EmployeeId" />
		<br>
		<b>Account Id: </b>
		...
		<br>
		<b>Bank Name: </b>
		<dsp:input type="text" bean="EmployeeProfileFormHandler.bankName" />
		<br>
		<br>
		<b>Account Balance: </b>
		<dsp:input type="text"
			bean="EmployeeProfileFormHandler.accountBalance" />
		<br>
		<br>
		<br>
		<dsp:input type="submit"
			bean="EmployeeProfileFormHandler.addToExistingAccount" />
